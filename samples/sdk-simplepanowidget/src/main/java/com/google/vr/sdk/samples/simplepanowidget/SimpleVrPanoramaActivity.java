...
//    backgroundImageLoaderTask.execute(Pair.create(fileUri, panoOptions));
  ...
  public void changeImage(View view) {
    if(!doubleTime) {
      ...
      //Uri uri = Uri.parse("file:///android_asset/demo-converted.jpg");
      Uri uri = Uri.parse("file:///android_asset/andes.jpg");

      fileUri = uri;
      backgroundImageLoaderTask = new ImageLoaderTask();
//    Uri.parse("android.resource://" + getApplicationContext().getPackageName() + "/" + R.assets.test);
      ...
      backgroundImageLoaderTask.execute(Pair.create(inputStream, panoOptions));
      doubleTime = true;
    }else{
      backgroundImageLoaderTask = null;
      AssetManager assetManager = getAssets();
      InputStream inputStream = null;
      Toast.makeText(getApplicationContext(), "clicked double" +
              "", Toast.LENGTH_LONG).show();
      try {
        inputStream = assetManager.open("demo-converted.jpg");
      } catch (IOException e) {
        e.printStackTrace();
      }
      backgroundImageLoaderTask = new ImageLoaderTask();
